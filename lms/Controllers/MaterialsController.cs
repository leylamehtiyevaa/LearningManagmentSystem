...
namespace lms.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,VideoURL,ImageURL,Author,CourseId")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,VideoURL,ImageURL,Author,CourseId")] Material material)
        {
            if (id != material.Id)
            {
                return NotFound();
